...
fn main() {
    ...
    let mut trainer = Trainer::<AdamWOptimiser, _, _>::new(
        ...
        output_buckets,
        vec![
            SavedFormat::new("l0", QuantTarget::Float, Layout::Normal),
            SavedFormat::new("l1", QuantTarget::Float, Layout::Normal),
            SavedFormat::new("l2", QuantTarget::Float, Layout::Normal),
            SavedFormat::new("l3", QuantTarget::Float, Layout::Normal),
